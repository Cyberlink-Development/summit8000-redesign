<div class="col-md-9">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="inputStandard" class="col-lg-2 control-label">Experience</label>
                <div class="col-lg-8">
                    <div class="bs-component">
            ...
            <div class="form-group">
                <label for="inputStandard" class="col-lg-2 control-label">Specialisation</label>
                <div class="col-lg-8">
                    <div class="bs-component">
            ...
            <div class="form-group">
                <label for="inputStandard" class="col-lg-2 control-label">Certifications
            ...
            <div class="form-group">
                <label for="inputStandard" class="col-lg-2 control-label">Languages
                </label>
                <div class="col-lg-8">
                    <div class="bs-component">
                        ...
                        <select name="category" class="form-control team-select">
                            ...
                            @if ($category)
                                @foreach ($category as $row)
                                    <option value="{{ $row->id }}"
                                        {{ $row->id == $data->category ? 'selected' : '' }}> {{ $row->category }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
            ...
            <div class="form-group">
    <label for="inputStandard" class="col-lg-2 control-label">Instagram Link

    </label>
    <div class="col-lg-8">
        <div class="bs-component">
            <input type="text" name="instagram_url" class="form-control" placeholder="Instagram Link"
...
<div class="form-group">
    <label for="inputStandard" class="col-lg-2 control-label">LinkedIn Link

    </label>
    <div class="col-lg-8">
        <div class="bs-component">
            <input type="text" name="linkedin_url" class="form-control" placeholder="LinkedIn Link"
    ...
    <div class="admin-form">
        <div class="sid_bvijay mb10">
            <div class="hd_show_con">
                <div class="publice_edi">
                    Active Status: <input type="checkbox" name="status" value="{{ $data->status }}"
        ...
        <div class="sid_bvijay mb10">
            <label class="field text">
                Ordering: <input type="number" name="ordering" class="form-control" placeholder="Ordering"
                    value="{{ $data->ordering }}" />
            </label>
        </div>
        {{-- <div class="sid_bvijay mb10">
                ...
                <div id="xedit-demo">
                    @if ($data->thumbnail)
                        <span class="thumb_id{{ $data->id }}">
                            ...
                            <img src="{{ asset(env('PUBLIC_PATH') . 'uploads/team/' . $data->thumbnail) }}"
                                width="150" />
                        </span>
                        <hr>
                    @endif
